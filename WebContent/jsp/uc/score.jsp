	    ...
	    <div class="i_main zichan_main">
	        ...
	        <div class="zichan_right">
                ...
                <div class="zc_right_main">
                    <p class="font14 line_height30">亲爱的会员HH${user.id }，欢迎你！</p>
                    <p class="font14 line_height30">你的小金库有：<a href="#" class="color_red fontbold">${account.s2 }</a>金；还有<a href="#" class="color_red fontbold">${account.uncheck }</a>金正运往你的小金库</p>
                    ...
                    <div class="zhanghao_border">
                    	<table id="j_scorelogs" width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#f2f2f2" class="color_66">
                          <tr class="height37">
                            <td bgcolor="#fafafa">获得时间</td>
                            <td bgcolor="#fafafa">参与时间</td>
                            <td bgcolor="#fafafa">数量</td>
                            <td bgcolor="#fafafa">奖励类型</td>
                            <td bgcolor="#fafafa">发放状态</td>
