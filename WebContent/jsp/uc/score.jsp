	    ...
	    <div class="i_main zichan_main">
	        ...
	        <div class="zichan_right">
                ...
                <div class="zc_right_main">
                    <p class="font14 line_height30">亲爱的会员 ${user.nick }，欢迎你！</p>
                    <p class="font14 line_height30">你的小金库有：<a href="#" class="color_red fontbold">${account.alipay }</a> ${config.score_unit }</p>
