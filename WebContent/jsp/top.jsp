...
<div class="i_top_bg" id="top">
	...
	<div id="nouser"  class="i_top">您好！<span class="top_user_name">朋友</span><a href="${config.system_control_url }/qqbind" class="qq">QQ登录</a></div>
	<div id="haveuser" class="i_top" style="display:none">
		您好！<span class="top_user_name"></span><a href="${config.system_control_url }/logout">退出</a>
