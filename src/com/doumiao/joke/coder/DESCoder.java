...
public abstract class DESCoder {
	 ...
	 * @throws Exception
	 */
	public static byte[] decrypt(String data, String key, Charset charset) throws Exception {
		Key k = toKey(Base64.getDecoder().decode(key.getBytes(charset)));

		Cipher cipher = Cipher.getInstance(ALGORITHM);
		cipher.init(Cipher.DECRYPT_MODE, k);

		return cipher.doFinal(Base64.getDecoder().decode(data.getBytes(charset)));
	}
